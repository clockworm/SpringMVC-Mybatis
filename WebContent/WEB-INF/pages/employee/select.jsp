					...
					<div class="row form-group">
						...
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeePhone">电话号码</label> <input type="text"
								...
								name="employeePhone" readonly="readonly">
						</div>
					</div>
					<div class="row form-group">
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeeAddress">家庭地址</label> <input type="text"
								...
								readonly="readonly" value="${employee.employeeAddress}">
						</div>
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeeEmail">邮箱</label> <input type="text"
								class="form-control" readonly="readonly" id="employeeEmail"
					...
					<div class="row form-group">
							...
							<div class="margin-right-15 templatemo-inline-block">
								<c:choose>
									<c:when test="${employee.employeeSex=='男'}">
										<input type="radio" readonly="readonly" name="employeeSex"
											id="r4" checked="checked" value="男">
						...
						<div class="col-lg-6 col-md-6 form-group">
							<label class="control-label templatemo-block">年龄</label> <select
								class="form-control" name="employeeAge" disabled="disabled">
						...
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeeSchool">毕业院校</label> <input
								readonly="readonly" type="text" class="form-control"
								id="employeeSchool" value="${employee.employeeSchool}"
								name="employeeSchool">
						</div>
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeeCode">员工编号</label> <input type="text"
								class="form-control" readonly="readonly"
								value="${employee.employeeCode}" id="employeeCode"
								name="employeeCode">
						</div>
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeeEmail">入职时间</label> <input type="text"
								class="form-control" readonly="readonly" id="employeeEmail"
								name="employeeEmail"
								value="<fmt:formatDate value="${employee.createDate }"  pattern="yyyy年MM月dd日" />">
						</div>
					</div>
					<div class="row form-group">
						<div class="col-lg-6 col-md-6 form-group">
							<label class="control-label templatemo-block">学历</label> <select
								class="form-control" name="employeeEducatio" disabled="disabled">
								<c:choose>
						...
						<div class="col-lg-6 col-md-6 form-group">
							<label for="employeeCard">身份证号码</label> <input type="text"
								class="form-control" id="employeeCard" name="employeeCard"
								readonly="readonly" value="${employee.employeeCard}"
								maxlength="18">
						</div>
					</div>
					<div class="row form-group">
						<div class="col-lg-12 form-group">
							<label class="control-label templatemo-block">职位安排</label> <select
								...
								name="employeePosition" disabled="disabled"
